...
# partie 1.1
df1 = pd.read_csv("../output/1_2_LR_BOW.csv")
df2 = pd.read_csv("../output/1_2_LR_IDF.csv")
df3 = pd.read_csv("../output/1_2_RF_BOW.csv")
df4 = pd.read_csv("../output/1_2_RF_IDF.csv")
df5 = pd.read_csv("../output/1_2_MLP_BOW.csv")
df6 = pd.read_csv("../output/1_2_MLP_IDF.csv")
#
